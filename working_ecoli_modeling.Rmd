...
x <- cbind(as.matrix(train[, 4:27]), month_dummy, day_of_week_dummy)
...
x_test <- cbind(as.matrix(test[, 4:27]), month_dummy, day_of_week_dummy)
...
#fitting full model
mod_full <- lm(data = train[,-1], log_ecoli~.)
