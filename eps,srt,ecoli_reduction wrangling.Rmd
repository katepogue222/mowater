...
Scratchpad
```{r}
compare <- NAB2 %>% select( "NNE E.coli (LAB) EC/100mL", 
...
ecoli <- NAB2 %>% select(timestamp, "NNE E.coli (LAB) EC/100mL",
                         "NAB2 Clarifier Effluent E. coli (LAB) (EC/100mL)", 
                         "NAB4 Clarifier Effluent E. coli (LAB) (EC/100mL)", 
                         "NSI E. coli (LAB) (EC/100mL)", 
                         "NAB9 Clarifier Effluent E. coli (LAB) (EC/100mL)")
...
ecoli$log_control_ecoli <- log(ecoli$`NNE E.coli (LAB) EC/100mL`, base = 10)
