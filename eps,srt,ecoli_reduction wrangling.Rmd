...
```{r}
# Write Pilot FILLED
write.csv(pilot_eps_filled, file = "/Users/katepogue/Desktop/git_mowater/data/pilot_eps_filled.csv", row.names = FALSE)

# Write Pilot REMOVE
write.csv(pilot_eps_removed, file = "/Users/katepogue/Desktop/git_mowater/data/pilot_eps_removed.csv", row.names = FALSE)

# Write Control FILLED
write.csv(control_eps_filled, file = "/Users/katepogue/Desktop/git_mowater/data/control_eps_filled.csv", row.names = FALSE)

# Write Control REMOVED
write.csv(control_eps_removed, file = "/Users/katepogue/Desktop/git_mowater/data/control_eps_removed.csv", row.names = FALSE)
