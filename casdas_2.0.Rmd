...
NAB2$log_pilot_NAB2 <- log(NAB2$`NAB2 Clarifier Effluent E. coli (LAB) (EC/100mL)`, base = 10)
NAB2$log_control_NAB2 <- log(NAB2$`NAB4 and 9 Clarifier Effluent E. coli (LAB) (EC/100mL)`, base = 10)
...
view(control_eps$AB4_and_9_INF_FLOW)
...
variable_names <- names(all_casdas)[2:49]
